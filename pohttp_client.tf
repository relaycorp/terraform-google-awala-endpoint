...
#  name     = "awala-endpoint-${random_id.resource_suffix.hex}-pohttp-client"
#  location = var.region
...
#}
#
#resource "google_cloud_run_service_iam_member" "pohttp_client_public_access" {
#  location = google_cloud_run_v2_service.pohttp_client.location
#  project  = google_cloud_run_v2_service.pohttp_client.project
